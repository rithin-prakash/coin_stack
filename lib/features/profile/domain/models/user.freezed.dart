...
mixin _$User {
 ...
 String get phone; String get phoneCode; String? get email; String? get addressLine; String? get city; String? get pincode; String? get fullName; String? get username; DateTime? get dob; Country? get residentCountry; bool get phoneVerified; bool get idVerified; bool get photoVerified;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is User&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.phoneCode, phoneCode) || other.phoneCode == phoneCode)&&(identical(other.email, email) || other.email == email)&&(identical(other.addressLine, addressLine) || other.addressLine == addressLine)&&(identical(other.city, city) || other.city == city)&&(identical(other.pincode, pincode) || other.pincode == pincode)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.username, username) || other.username == username)&&(identical(other.dob, dob) || other.dob == dob)&&(identical(other.residentCountry, residentCountry) || other.residentCountry == residentCountry)&&(identical(other.phoneVerified, phoneVerified) || other.phoneVerified == phoneVerified)&&(identical(other.idVerified, idVerified) || other.idVerified == idVerified)&&(identical(other.photoVerified, photoVerified) || other.photoVerified == photoVerified));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,phone,phoneCode,email,addressLine,city,pincode,fullName,username,dob,residentCountry,phoneVerified,idVerified,photoVerified);

@override
String toString() {
  return 'User(phone: $phone, phoneCode: $phoneCode, email: $email, addressLine: $addressLine, city: $city, pincode: $pincode, fullName: $fullName, username: $username, dob: $dob, residentCountry: $residentCountry, phoneVerified: $phoneVerified, idVerified: $idVerified, photoVerified: $photoVerified)';
}
...
@useResult
$Res call({
 String phone, String phoneCode, String? email, String? addressLine, String? city, String? pincode, String? fullName, String? username, DateTime? dob, Country? residentCountry, bool phoneVerified, bool idVerified, bool photoVerified
});
...
class _User implements User {
   _User({required this.phone, required this.phoneCode, this.email, this.addressLine, this.city, this.pincode, this.fullName, this.username, this.dob, this.residentCountry, this.phoneVerified = false, this.idVerified = false, this.photoVerified = false});
...
@override $CountryCopyWith<$Res>? get residentCountry;
